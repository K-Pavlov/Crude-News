...
namespace CrudeNews.Web.Areas.Administrator.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,IsMainNews")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,IsMainNews")] Category category)
        {
            if (ModelState.IsValid)
            {
